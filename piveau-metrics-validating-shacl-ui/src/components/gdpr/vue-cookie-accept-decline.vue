    ...
    >
      ...
      >
        ...
        <div :class="'cookie__' + type + '__buttons'">
          <button
            :class="['cookie__' + type + '__buttons__button', 'cookie__'
              + type + '__buttons__button--accept']"
            @click="accept"
          >
          ...
          <button
            ...
            :class="['cookie__' + type + '__buttons__button', 'cookie__'
              + type + '__buttons__button--decline']"
            @click="decline"
          >
  ...
  methods: {
    ...
    setCookieStatus(type) {
      if (this.supportsLocalStorage) {
        ...
        if (type === 'accept') {
          this.setCookie(`vue-cookie-accept-decline-${this.elementId}`, 'accept');
        }
        if (type === 'decline') {
          this.setCookie(`vue-cookie-accept-decline-${this.elementId}`, 'decline');
        }
        if (type === 'postpone') {
          this.setCookie(`vue-cookie-accept-decline-${this.elementId}`, 'postpone');
        }
      }
    },
    getCookieStatus() {
    ...
    setCookie(key, value) {
      if (this.cookiesAllowed) {
        tinyCookie.set(`${key}`, `${value}`, { expires: '1Y' });
      }
    },
  },
};
